 ...
 */
export async function fetchWithTimeoutAndRetry(url: string, opts: RequestInit = {}, timeoutMs = 8000, retries = 2): Promise<Response> {
  let attempt = 0;
...
export async function getJson(url: string, opts: RequestInit = {}, timeoutMs = 8000, retries = 2): Promise<any> {
